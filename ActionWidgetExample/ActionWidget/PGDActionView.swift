...
class PGDActionView: UIView {
    ...
    var fillRatingImage = #imageLiteral(resourceName: "fill.png")
    var outlineRatingImage = #imageLiteral(resourceName: "outline.png")
    ...
    var zoomInImage: UIImage? {
        didSet {
            if let zImage = zoomInImage {
                ...
                actionDetailButtonImage.image = #imageLiteral(resourceName: "zoom_in.png")
            }
        }
    }

    var zoomOutImage = #imageLiteral(resourceName: "zoom_out.png")
    ...
    var shareImage: UIImage? {
        didSet {
            if let sImage = shareImage {
                ...
                actionShareButtonImage.image = #imageLiteral(resourceName: "share.png")
            }
        }
    }
    ...
    @IBAction func rotate(_ sender: Any) {
        UIView.transition(with: self, duration: 0.5, options: .transitionFlipFromLeft, animations: {
            if self.detailView.isHidden {
                ...
                self.actionDetailButtonImage.image = self.zoomInImage == nil ? #imageLiteral(resourceName: "zoom_in.png") : self.zoomInImage!
            }
        }, completion: nil)
    }
    ...
    fileprivate func commonInit() {
        Bundle.main.loadNibNamed("PGDActionView", owner: self, options: nil)
